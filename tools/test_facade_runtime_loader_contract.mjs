...
assert(CATALOG_SCHEMA === "ti.facade-recognition-catalog/9" && RUNTIME_SCHEMA === "ti.facade-runtime-registry/9" && ADAPTER_CONTRACT_SCHEMA === "ti.facade-runtime-adapter-contracts/8" && LOADER_API_VERSION === "ti.facade-runtime-registry-loader/8" && COMPILER_VERSION === "1.8.1", "D2 1441 promotion version matrix drifted");
