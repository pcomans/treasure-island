...
assert(JSON.stringify(currentTopologyPlans) === JSON.stringify(["active-adapter:bayside-1226-live:building:w96215685:wall"]), "1226 is not the sole current-integration topology plan authority");
