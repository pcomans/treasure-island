...
First quit any older game window (`Esc`, then `Q` while paused). After the reviewed MAIN transfer, use `build/maceo-may-exact-current-001/Treasure Island First Playable.app` with no launch arguments. The project selects the case-sensitive `Dummy` audio driver itself. Historical and candidate apps retain separate identities.

Executable SHA-256 `ed29698fa03da04fc85a4a282fc2311a99ee0da4a86f1e0ff4cf2124e4bdb211`; PCK SHA-256 `aa60f0e4e806e1db8922d6f524ba79126f21cd74868690cf7f6bffc42d37c397` (`76,510,240` bytes); seven-file identity `f372f9cb947745299ba5bbcd7a69a253b8c24fdca1f348b4cfbdd3d69c892d51`. This byte-identical transfer supplies no new screenshots or manual acceptance.
