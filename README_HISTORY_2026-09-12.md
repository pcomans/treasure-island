# README history — 2026-09-12 snapshot

This file preserves the complete prior root `README.md` verbatim below this note. It is historical reference only: its internal “current”, “pending”, export, and release wording records earlier snapshots and must not be used as active launch guidance. Relative Markdown links remain valid because this archive is kept at the repository root.
...
## Current Maceo May release — sixteen recognized buildings
...
## Historical Fire Station48 release — fifteen recognized buildings
