...
const REGISTRY_SCHEMA_VERSION := "ti.facade-runtime-registry/15"
const ADAPTER_CONTRACT_SCHEMA_VERSION := "ti.facade-runtime-adapter-contracts/14"
const CATALOG_SCHEMA_VERSION := "ti.facade-recognition-catalog/15"
...
const EXPECTED_ADAPTER_COUNT := 23
const EXPECTED_READY_ADAPTER_COUNT := 17
...
const EXPECTED_REFERENCE_RECOGNIZABLE_COUNT := 15
...
const D5_1308_BUILDER_SHA256 := "8059a635b6f0b5ff272f1de1a7d0b4531c6b44111755efeefad3aaedc1741619"
...
const D5_1394_BUILDER_SHA256 := "8059a635b6f0b5ff272f1de1a7d0b4531c6b44111755efeefad3aaedc1741619"
...
const D5_1317_BUILDER_SHA256 := "8059a635b6f0b5ff272f1de1a7d0b4531c6b44111755efeefad3aaedc1741619"
...
const FIRE_STATION48_BUILDER_SHA256 := "8059a635b6f0b5ff272f1de1a7d0b4531c6b44111755efeefad3aaedc1741619"
...
func _validate_registry(registry: Dictionary) -> bool:
	...
	if not _require(legacy_adapters.size() == 9 and active_adapters.size() == 14 and adapters.size() == EXPECTED_ADAPTER_COUNT, "registry_count_drift", "Runtime adapter arrays do not match the expected legacy/active counts."):
		return false
...
func _validate_reference_acceptance_record(unit_id: String, records: Array) -> bool:
	...
	if unit_id in ["physical-building:w95934105", "physical-building:w95934144", "physical-building:w95934117", "physical-building:w95934123", "physical-building:w96215646", "physical-building:w95934125", "physical-building:w764313741"]:
...
func _validate_current_topology_authority(active_adapters: Array) -> bool:
	...
	return _require(
		current_topology_adapter_ids == [FIRE_STATION48_ADAPTER_ID],
		"current_topology_authority_mismatch",
		"Exactly the Station48 adapter must own the measured combined integration topology; prior evidence scopes must remain historical.",
	)
