extends Node3D
## Candidate live factory derived from the frozen 1238 study; geometry is unchanged.
...
const SELF_PATH := "res://game/scripts/world/facades/northpoint_1238_live_factory.gd"
