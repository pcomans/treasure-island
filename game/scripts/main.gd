...
func _finish_mac_export_smoke(report: Dictionary) -> void:
	...
	var projected_1397_attachment_valid: bool = _mac_export_projected_family_attachment_valid(preload("res://game/scripts/world/facades/gateview_1397_live_replacement.gd"), "1397")
	var projected_1226_attachment_valid: bool = _mac_export_projected_family_attachment_valid(preload("res://game/scripts/world/facades/bayside_1226_live_replacement.gd"), "1226")
	...
	var valid := world_root.is_world_validated() \
		...
		and projected_1397_attachment_valid \
		and projected_1226_attachment_valid \
