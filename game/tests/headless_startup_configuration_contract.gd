...
func _initialize() -> void:
	...
	or GameMain.EXPECTED_TRIANGLES != EXPECTED_RUNTIME_TRIANGLES:
		_fail("The packaged main-scene smoke oracle does not match the accepted-through-1441 topology 959/974/69252.")
		return
	...
	or "physical-building:w95934105" not in accepted_ids:
		...
		return
	print("PASS: project startup selects exact Dummy audio before AudioServer initialization, packaged smoke expects accepted-through-1441 topology 959/974/69252, and accepted facade authority is exact runtime-registry v9 at 9/213 with one 1441 credit")
	quit(0)
