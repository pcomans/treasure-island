...
for t in manifest['targets']:
 ...
 parts.append('</div>')
 if t['source_key'] in CAPTURE_OVERRIDES:
  comparison='quality-round2.html' if run.startswith('quality-round2') else 'quality-round1.html'
