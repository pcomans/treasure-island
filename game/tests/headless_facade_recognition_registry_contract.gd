...
func _validate_runtime_adapters(registry: Dictionary) -> void:
	...
	_require(current_topology_adapter_ids == ["active-adapter:bayside-1226-live:building:w96215685:wall"], "1226 is not the sole current-integration topology authority.")
