...
## Fresh ordinary-main evidence for the accepted D2 1441 live replacement under
## current v9 authority. The packet grants no additional recognition credit.
...
const D2_CAPTURE_TIME_METRIC := "9/213"
const D2_FROZEN_ATTACHMENT_METRIC := "8/213"
...
const D2_OUTPUT := "res://evidence/first-playable/d2-1441-postpromotion-v9-2026-09-07-001"
const D2_REHEARSAL_OUTPUT := "user://d2-1441-postpromotion-v9-complete-rehearsal-2026-09-07"
const D2_APP_BUNDLE_RELATIVE_PATH := "build/d2-1441-postpromotion-v9-2026-09-07-001/Treasure Island First Playable.app"
const D2_GENERATOR_PATH := "res://game/tests/d2_1441_postpromotion_v9_capture.gd"
const D2_PARENT_CAPTURE_PATH := "res://game/tests/isle_house_low_live_evidence_capture.gd"
const D2_FOCUSED_PATH := "res://game/tests/headless_d2_1441_postpromotion_v9_contract.gd"
const D2_PACKAGE_PATH := "res://game/tests/headless_d2_1441_postpromotion_v9_package_contract.gd"
...
const D2_SEMANTIC_AUDIT_PATH := "res://evidence/reviews/d2-1441-promotion-v9-2026-09-07-INDEPENDENT_SEMANTIC_AUDIT.md"
const D2_SEMANTIC_AUDIT_SHA256 := "3388576780493b6116c126684072426ad22279b9a3508127a0ffc8bcb77f9700"
const D2_SEMANTIC_AUDIT_VERDICT := "PASS_FOR_V9_POSTPROMOTION_EXPORT"
const D2_RECEIPT_TOOL_PATH := "res://tools/build_d2_1441_postpromotion_v9_package_verification_receipt.mjs"
const D2_RECEIPT_TOOL_SHA256 := "1ead2f87ab103d42d483473f40d0fff383cef46f35dd6e5ce55b339e92cf611d"
const D2_ACTIVE_ADAPTER_ID := "active-adapter:d2-1441-live:building:w95934105:wall"
...
const D2_PACKAGE_RECEIPT_SCHEMA := "ti.d2-1441-postpromotion-v9-package-verification/1"
const D2_STATIC_SCHEMA := "ti.d2-1441-postpromotion-v9-static-evidence/1"
const D2_MOTION_SCHEMA := "ti.d2-1441-postpromotion-v9-motion-telemetry/1"
const D2_VISUAL_SCHEMA := "ti.d2-1441-postpromotion-v9-visual-motion/1"
...
const D2_DEPENDENCY_HASHES := {
	...
	D2_FOCUSED_PATH: "64a7bdc8d770254df26a56b51493d9e8c7e29a1f786e2ed5888822b7747b870b",
	D2_PACKAGE_PATH: "03a2276ec072a27ddc63ad1b0b8551a9c8e2d30586c317c67883b9b3f2965630",
	...
	D2_REGISTRY_PATH: "26dcf64a34cf92aa7766c60940933190cdb5f9bc595dc23dc2f16fa01752e16c",
	D2_CONTRACTS_PATH: "8c61ea5601ab94852ac593b8658963b52cb5253aae22a2ff109f2e46771caa93",
	D2_CATALOG_PATH: "dc6d121d48621f98a203f2fea458316a46446a11e5f2a77d4064694322b2baa2",
	D2_SCHEMA_PATH: "8896fb9dcfd1cb48fc4bf0ed7ddc5fa50fdf7ec31335111291a1e2a2006e106d",
	D2_LOADER_PATH: "32e63c8774c0589856f15ac2ca0e7458e1cdce1403380e50a6ba99bd5185bd26",
	D2_COMPILER_PATH: "4d6da1afa587d2dd8aefb24775d6ba838dd39ac60131985c9c899209572d3e74",
	D2_SEMANTIC_AUDIT_PATH: D2_SEMANTIC_AUDIT_SHA256,
	D2_RECEIPT_TOOL_PATH: D2_RECEIPT_TOOL_SHA256,
...
func _d2_run() -> void:
	...
	if mode == "source-contract":
		...
		and _require(_d2_dependencies_match(), "D2 postpromotion dependency closure drifted.") \
		...
		and _require(not DirAccess.dir_exists_absolute(ProjectSettings.globalize_path(D2_OUTPUT)), "Authoritative D2 postpromotion packet already exists before capture."):
			print("PASS: D2 1441 postpromotion capture source contract is exact, ordinary-main-only, input-driven, current at v9 9/213, adds no recognition credit, and has no existing packet or override")
		_finish(null)
		return
	if mode == "validate":
		...
		and _require(_d2_validate_complete_packet(D2_OUTPUT, true), "D2 authoritative packet failed complete disk validation."):
			print("PASS: D2 postpromotion packet is exactly 40 acyclic files with 14 static and 21 post-draw motion PNGs plus three manifests, override copy, and external receipt")
		_finish(null)
		return
	...
	or not _require(_d2_dependencies_match(), "D2 postpromotion dependency closure drifted.") \
...
func _d2_validate_bindings(world: WorldLoader) -> Dictionary:
	...
	or str(metadata.get("accepted_recognition_metric", "")) != D2_FROZEN_ATTACHMENT_METRIC \
...
func _d2_capture_stills(main: GameMain, world: WorldLoader, player: PlayerController, hud: GameHUD, sun: DirectionalLight3D, bindings: Dictionary, output_root: String, authoritative: bool) -> void:
	...
	var manifest := {
		...
		"recognition_status": "current_v9_accepted_no_additional_credit_pending_two_postpromotion_audits",
		...
		"proof_role": "native_ordinary_main_already_integrated_input_only_static_postpromotion_evidence",
		"target": {
		...
		"truth_boundary": {
			...
			"reference_recognizability_accepted_under_current_v9_authority": true,
			"production_visual_review_accepted_before_v9_promotion": true,
			"capture_time_adapter_metadata_recognition_accepted": false,
			"postpromotion_packet_additional_credit": false,
		...
		"independent_v9_semantic_audit": {"path": D2_SEMANTIC_AUDIT_PATH.trim_prefix("res://"), "sha256": D2_SEMANTIC_AUDIT_SHA256, "verdict": D2_SEMANTIC_AUDIT_VERDICT},
		...
		"capture_command": ".tools/godot/4.7.2/Godot.app/Contents/MacOS/Godot --path . --display-driver macos --rendering-method forward_plus --rendering-driver metal --audio-driver Dummy --resolution 1440x900 --script game/tests/d2_1441_postpromotion_v9_capture.gd -- --capture-mode=%s --generator-sha256=<exact> --package-verification-receipt=<external> --package-verification-receipt-sha256=<exact>" % ("stills" if authoritative else "review-stills"),
		...
		"visual_verdict": "pending_independent_postpromotion_visual_review",
	...
	if not _d2_validate_static_stage(output_root, authoritative):
		...
		return
	print("PASS: captured 14 native D2 postpromotion stills from ordinary main with input-only travel/aim, same-pose changed light, grayscale, spray, roof landing, protected return, and four current-world comparators")
...
func _d2_dependencies_match() -> bool:
	for path: String in D2_DEPENDENCY_HASHES:
		if FileAccess.get_sha256(path) != str(D2_DEPENDENCY_HASHES[path]):
			...
			return false
	return _d2_semantic_audit_matches() and _d2_authority_is_exact()


func _d2_semantic_audit_matches() -> bool:
	if not FileAccess.file_exists(D2_SEMANTIC_AUDIT_PATH) \
	or FileAccess.get_sha256(D2_SEMANTIC_AUDIT_PATH) != D2_SEMANTIC_AUDIT_SHA256:
		return false
	var lines := FileAccess.get_file_as_string(D2_SEMANTIC_AUDIT_PATH).strip_edges().split("\n")
	return not lines.is_empty() and str(lines[-1]).strip_edges() == D2_SEMANTIC_AUDIT_VERDICT
...
func _d2_authority_is_exact() -> bool:
	...
	var disabled := plans.filter(func(value: Variant) -> bool: return str((value as Dictionary).get("integration_state", "")) == "hard_disabled_source_projection")
	var d2_adapters := (registry.get("active_runtime_adapters", []) as Array).filter(func(value: Variant) -> bool: return value is Dictionary and str((value as Dictionary).get("adapter_id", "")) == D2_ACTIVE_ADAPTER_ID and str((value as Dictionary).get("receiver_key", "")) == D2_WALL_KEY)
	var d2_plans := plans.filter(func(value: Variant) -> bool: return value is Dictionary and str((value as Dictionary).get("receiver_key", "")) == D2_WALL_KEY)
	var receipts := registry_unit.get("acceptance_records", []) as Array
	...
	return str(registry.get("schema_version", "")) == "ti.facade-runtime-registry/9" \
		and str(catalog.get("schema_version", "")) == "ti.facade-recognition-catalog/9" \
		...
		and int(metric.get("numerator", -1)) == 9 and int(metric.get("denominator", -1)) == 213 and str(metric.get("display", "")) == D2_CAPTURE_TIME_METRIC \
		and accepted.size() == 9 and accepted.count("physical-building:w95934105") == 1 \
		and (registry.get("units", []) as Array).size() == 213 \
		and (registry.get("active_runtime_adapters", []) as Array).size() == 8 \
		and plans.size() == 17 and ready.size() == 11 and disabled.size() == 6 \
		and registry_unit.get("active_runtime_adapter_ids", []) == [D2_ACTIVE_ADAPTER_ID] \
		and str(registry_unit.get("runtime_content_mode", "")) == "all_receivers_active_d2_1441_paired_replacement" \
		and receipts.size() == 1 and int((receipts[0] as Dictionary).get("numerator_effect", -1)) == 1 \
		and str((receipts[0] as Dictionary).get("status", "")) == "accept" \
		and catalog_receipts == receipts \
		and str((registry_unit.get("claim_status", {}) as Dictionary).get("reference_recognizable", "")) == "accepted" \
		and str((catalog_unit.get("claim_status", {}) as Dictionary).get("reference_recognizable", "")) == "accepted" \
		and d2_adapters.size() == 1 and d2_plans.size() == 1 \
		and str((d2_plans[0] as Dictionary).get("integration_state", "")) == "package_safe_ready_for_integration"
...
func _d2_authority_receipt() -> Dictionary:
	return {
		...
		"accepted_physical_units": 9,
		"physical_unit_inventory": 213,
		"not_evaluated_physical_units": 204,
		"active_adapters": 8,
		"integration_plans": 17,
		"package_safe_ready_plans": 11,
		"disabled_plans": 6,
		"d2_1441_authority_mode": "all_receivers_active_d2_1441_paired_replacement",
		"d2_1441_live_runtime_candidate_uncredited_at_capture_time": true,
		"d2_1441_acceptance_records": 1,
		"d2_1441_active_authority_adapters": 1,
		"recognition_credit_already_accepted": true,
		"additional_recognition_credit": false,
		"promotion": false,
	}
...
func _d2_receipt_argument_matches() -> bool:
	...
	var generator := receipt.get("receipt_generator", {}) as Dictionary
	return str(receipt.get("schema_version", "")) == D2_PACKAGE_RECEIPT_SCHEMA \
		and str(receipt.get("candidate_status", "")) == "uncommitted_v9_candidate_pending_two_independent_postpromotion_audits" \
		...
		and str(receipt.get("semantic_audit_sha256", "")) == D2_SEMANTIC_AUDIT_SHA256 \
		and str(receipt.get("semantic_audit_verdict", "")) == D2_SEMANTIC_AUDIT_VERDICT \
		and bool(receipt.get("current_authority_target_accepted", false)) \
		and _d2_receipt_source_hashes_match(source_hashes) \
		and str(generator.get("path", "")) == D2_RECEIPT_TOOL_PATH.trim_prefix("res://") \
		and str(generator.get("sha256", "")) == D2_RECEIPT_TOOL_SHA256 \
...
func _d2_receipt_source_hashes_match(source_hashes: Dictionary) -> bool:
	if str(source_hashes.get(D2_GENERATOR_PATH.trim_prefix("res://"), "")) != FileAccess.get_sha256(D2_GENERATOR_PATH):
		return false
	for path: String in D2_DEPENDENCY_HASHES:
		if str(source_hashes.get(path.trim_prefix("res://"), "")) != str(D2_DEPENDENCY_HASHES[path]):
			return false
	return true
