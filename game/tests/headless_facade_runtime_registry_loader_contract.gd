...
const EXPECTED_REGISTRY_SHA256 := "82f77d9a4bf70aa7905d66b0347a29b267e899e3c4cef6722342cc4139be1e18"
const EXPECTED_ADAPTER_CONTRACT_SHA256 := "d9f79936c5b1921cf04a0da2581fc9bf39f3c1bb7d5a7a337f22ab9157210103"
...
func _run() -> void:
	...
	_report_measurement_phase("seventeen_target_mutations", phase_started_usec, phase_counters)
	phase_started_usec = Time.get_ticks_usec()
	phase_counters = RegistryLoader.measurement_snapshot()
	if not _failed:
		print("PASS: facade runtime loader is version-pinned and topology-neutral: 213 units / 214 receivers / 32/213 reference-recognizable physical units / 40 adapter plans / 34 package-safe / 6 hard-disabled receivers / 13 unique pathless disabled projection inputs across 13 occurrences; registry %s; adapter contracts %s; snapshot %s" % [EXPECTED_REGISTRY_SHA256, EXPECTED_ADAPTER_CONTRACT_SHA256, first_snapshot.sha256_text()])
...
func _validate_receiver_modes(loader: RefCounted) -> void:
	...
	var expected_ids := ["physical-building:r16681702", "physical-building:r19685981", "physical-building:w96215688", "physical-building:w96215682", "physical-building:w96215674", "physical-building:w96215673", "physical-building:w96215666", "physical-building:w96215659", "physical-building:w96215651", "physical-building:w96215653", "physical-building:w96215661", "physical-building:w96215658", "physical-building:w96215652", "physical-building:w96215649", "physical-building:w96215680", "physical-building:w96215677", "physical-building:w96215669", "physical-building:w96215672", "physical-building:w1222720021", "physical-building:w1249412093", "physical-building:w1249412094", "physical-building:w291189336", "physical-building:w34313540", "physical-building:w34313545", "physical-building:w95934105", "physical-building:w95934117", "physical-building:w95934119", "physical-building:w95934144", "physical-building:w95934123", "physical-building:w96215646", "physical-building:w95934125", "physical-building:w764313741"]
	accepted_ids.sort()
	expected_ids.sort()
	_require(int(metric.get("numerator", -1)) == 32 and int(metric.get("denominator", -1)) == 213 and str(metric.get("display", "")) == "32/213" and accepted_ids == expected_ids, "Loader recognition metric is not exactly the accepted 32/213 physical-unit rollup.")
...
func _validate_adapter_resolution(loader: RefCounted) -> void:
	...
	_require(current_topology_plan_ids == ["active-adapter:northpoint-1240-live:building:w96215688:wall"], "1240 is not the sole current-integration topology plan authority.")
...
func _validate_d5_batch_mutations(registry: Dictionary, contracts: Dictionary) -> void:
	for target: Dictionary in [{"unit_id": "physical-building:w95934123", "wall": "building:w95934123:wall", "number": "1308"}, {"unit_id": "physical-building:w96215646", "wall": "building:w96215646:wall", "number": "1394"}, {"unit_id": "physical-building:w95934125", "wall": "building:w95934125:wall", "number": "1317"}, {"unit_id": "physical-building:w764313741", "wall": "building:w764313741:wall", "number": "station48"}, {"unit_id": "physical-building:r19685981", "wall": "building:r19685981:wall", "number": "maceo"}, {"unit_id": "physical-building:w96215672", "wall": "building:w96215672:wall", "number": "1201"}, {"unit_id": "physical-building:w96215669", "wall": "building:w96215669:wall", "number": "1238"}, {"unit_id": "physical-building:w96215677", "wall": "building:w96215677:wall", "number": "1206"}, {"unit_id": "physical-building:w96215680", "wall": "building:w96215680:wall", "number": "1219"}, {"unit_id": "physical-building:w96215649", "wall": "building:w96215649:wall", "number": "1212"}, {"unit_id": "physical-building:w96215652", "wall": "building:w96215652:wall", "number": "1220"}, {"unit_id": "physical-building:w96215658", "wall": "building:w96215658:wall", "number": "1239"}, {"unit_id": "physical-building:w96215661", "wall": "building:w96215661:wall", "number": "1222"}, {"unit_id": "physical-building:w96215653", "wall": "building:w96215653:wall", "number": "1227"}, {"unit_id": "physical-building:w96215651", "wall": "building:w96215651:wall", "number": "1202"}, {"unit_id": "physical-building:w96215659", "wall": "building:w96215659:wall", "number": "1234"}, {"unit_id": "physical-building:w96215666", "wall": "building:w96215666:wall", "number": "1215"}, {"unit_id": "physical-building:w96215673", "wall": "building:w96215673:wall", "number": "1232"}, {"unit_id": "physical-building:w96215674", "wall": "building:w96215674:wall", "number": "1241"}, {"unit_id": "physical-building:w96215682", "wall": "building:w96215682:wall", "number": "1221"}, {"unit_id": "physical-building:w96215688", "wall": "building:w96215688:wall", "number": "1240"}]:
		...
		for mutation: Dictionary in [
			...
			{"section":"replacement_contract", "field":"actual_land_and_area_records_required", "value":str(target.number) in ["station48", "maceo", "1201", "1238", "1206", "1219", "1212", "1220", "1239", "1222", "1227", "1202", "1234", "1215", "1232", "1241", "1221", "1240"]},
		]:
