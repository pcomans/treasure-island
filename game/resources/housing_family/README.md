...
The owner-authorized `experiment/housing-family-instances` branch starts at `9c7f2440d3db6a7f2d0a5d474c612c0362a01c16` for A/B comparison with MAIN. Its [target inventory](../../../discovery/HOUSING_FAMILY_INSTANCES.md) distinguishes 23 photo-reviewed targets, 22 written matches needing pixel validation and 30 imagery-insufficient candidates. The straight prototype needs stepped runs, target opening schedules and appropriate roof/canopy variants before site use; a matching palette or six-metre cadence alone does not establish a fit. Keep per-target identity/grade/geometry and independent acceptance checks even when geometry is shared.
