...
const WORK := "/Volumes/Macintosh_HD/Users/user302070/Documents/Codex/2026-09-08/start-from-commit-f377dcac-and-read/work/northern-canopy-free-family-pilot-001/1237-1229-mechanics-001/1237"
const OUTPUT := "/private/tmp/1237-1229-mechanics-001/1237"
...
const LAND_KEYS := ["land:w26767313:x_-1__z_-4", "land:w26767313:x_-2__z_-4"]
...
func _run() -> void:
	...
	motion_data={"routes":[],"sprays":[],"drawn_range":[first_draw,first_draw],"movie_path":OUTPUT+"/1237-mechanics.avi","movie_hash_status":"bind_after_writer_terminal","physics_process_draw_and_encoded_indices_distinct":true,"continuous_traversal_between_setup_poses":false,"continuous_video_review_claim":false}
	...
	motion_data={"spray_phase_wall_usec":spray_phase_wall_usec,"timing_scope":"Monotonic wall microseconds; includes setup/aim/observations/tag marker within this phase. Distinct from fixed-FPS simulation and encoded duration; no avoided-run-time claim.","routes":route_attempts,"sprays":spray_attempts,"drawn_range":[first_draw,Engine.get_frames_drawn()],"movie_path":OUTPUT+"/1237-mechanics.avi","movie_hash_status":"bind_after_writer_terminal","physics_process_draw_and_encoded_indices_distinct":true,"continuous_traversal_between_setup_poses":false,"continuous_video_review_claim":false}
...
func _spray_case(spec:Dictionary,f:Dictionary) -> void:
	...
	if str(spec.expected_result)=="placed" and after>before:
		...
		ok=ok and identities==[{"derived_object_key":WALL_KEY,"source_keys":["w96665904"]}] and decal_state.derived_object_key==WALL_KEY and decal_state.source_keys==["w96665904"] and decal.cull_mask==2
...
func _save_marker(label:String,target:Vector3,expected_key:String,expected_shape:int) -> void:
	...
	print("Northpoint1237_MECHANICS_IMAGE "+path)
...
func _check_physical_reference() -> void:
	var reference:Dictionary=_json("/Volumes/Macintosh_HD/Users/user302070/Documents/Codex/2026-09-08/start-from-commit-f377dcac-and-read/work/northern-canopy-free-family-pilot-001/1237-1229-implementation-003/focused-1237-001-result.json")
	var checked:int=0
