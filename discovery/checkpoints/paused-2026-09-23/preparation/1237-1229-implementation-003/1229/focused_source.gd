extends SceneTree
const MODEL := preload("res://game/scripts/world/facades/northpoint_1229_study.gd")
const WORK := "/Volumes/Macintosh_HD/Users/user302070/Documents/Codex/2026-09-08/start-from-commit-f377dcac-and-read/work/northern-canopy-free-family-pilot-001/1237-1229-implementation-003/1229"
...
func _run() -> void:
	...
	var preflight := MODEL._json("/Volumes/Macintosh_HD/Users/user302070/Documents/Codex/2026-09-08/start-from-commit-f377dcac-and-read/work/northern-canopy-free-family-pilot-001/1237-1229-implementation-003/1229/PREFLIGHT_RESULT.json")
	...
	_check(wall.vertices.size() == 144 and wall.indices.size() == 72 and roof.vertices.size() == 24 and roof.indices.size() == 18, "Exact target wall roof cardinality.")
...
func _finish(result: Dictionary) -> void:
	...
	print("NORTHPOINT1229_FOCUSED_" + ("PASS" if failures.is_empty() else "FAIL") + " " + JSON.stringify(failures))
