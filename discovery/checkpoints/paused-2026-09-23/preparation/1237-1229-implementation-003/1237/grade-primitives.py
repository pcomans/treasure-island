...
chunk=REPO/'generated/world/chunks/x_-1__z_-4.json'; records=json.loads(chunk.read_text())['records']
wall=next(r for r in records if r['object_key']=='building:w96665904:wall')
adjacent_records=json.loads((REPO/'generated/world/chunks/x_-2__z_-4.json').read_text())['records']
def merged(prefix):
