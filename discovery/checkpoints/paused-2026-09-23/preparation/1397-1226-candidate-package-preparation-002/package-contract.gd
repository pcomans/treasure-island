...
## Shared candidate1397/1226 at current32; exact existing accepted records retained.
##1397/1226 remain unregistered and uncredited; frozen study metadata stays historical.
...
func _run() -> void:
	...
	if not mounted:
		var result := {"ok": not _failed, "measured_world": _measured_world, "gameplay_activation_observation": _gameplay_activation_observation, "authority": "32/213", "recognition_credit": 0, "scope": "Current32 exact source/remap and shared1397/1226 candidate attachments; neither target has recognition credit. Original study/source and distinct per-unit motion/visual evidence remain separately bound."}
...
func _ordinary_main() -> void:
	...
	print("SHARED1397_1226_GAMEPLAY_ACTIVATION: " + JSON.stringify(_gameplay_activation_observation))
