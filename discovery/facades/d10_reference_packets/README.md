...
The current v7 files may move as accepted live replacements are integrated.
...
receipts, current v7 cohort order/direct bindings, fields, packet links, source
...
physical objects. Each D10 run emits the moving current v7 catalog/registry
