...
> “schema-v7” below mean the last validated D7 packet boundary, not current
...
> D7 validator remains an intentionally unmigrated snapshot.
...
current schema-v7 catalog and registry only to rederive the exact D7 cohort
...
remained explicit and immutable; and the current schema-v7 catalog/registry
