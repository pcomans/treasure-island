...
const AUTHORITY = Object.freeze({
  catalog: Object.freeze({
    ...
    schema: "ti.facade-recognition-catalog/7",
  }),
  ...
  registry: Object.freeze({
    ...
    schema: "ti.facade-runtime-registry/7",
  }),
...
function validateAuthoritySplit(readme) {
  ...
  invariant(
    ...
    "D7 packet-time v4 receipts and current v7 binding authorities must remain explicitly separate",
  );
}
