...
The later [three-target refinement](../evidence/housing-family-experiment/refinement.html) addresses 1394 dark fascia and parking/walk/lawn separation, and 1227/1234 open screen rhythm. Independent visual review found these named refinements complete within the provisional study. Foreshortened ground widths, simplified weathering, inferred canopy supports/extent and hidden faces remain; counts and acceptance are unchanged.
